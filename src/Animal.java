...
public abstract class Animal implements Ator {
     ...
     * 
     * @param novosCoelhos Uma lista para retornar os animais recém-nascidos.
     */
    protected void reproduzir(List<Ator> novosCoelhos) {
    ...
    // sobrescreve o método agir da interface Ator
    @Override
    public abstract void agir(List<Ator> novosAnimais);

    /*
     * @return se o animal está vivo ou não
    */
    @Override
